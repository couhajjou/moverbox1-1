...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        <div class="col-md-8 col-lg-8">
            <h4 class="page-title">Availability Calendar</h4>
            <div class="breadcrumb-list">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Mover</a></li>
                ...
                <div class="col-md-4 col-lg-3 col-xl-2">
                    <div class="card m-b-30">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Mover Holidays</h5>
                        </div>
                        <div class="card-body">
                            <div id='external-events'>
                                <!-- <h4 class="m-b-15 font-16">Draggable Events</h4> -->
                                <div style="background-color: #f7bb4d;" class='fc-event'>Holiday</div>
                                <div style="background-color: #f9616d;" class='fc-event'>Unavailable</div>
                            </div>
                            <!-- checkbox -->
