        ...
        <div class="col-lg-6 col-xl-3">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="card-title mb-0">New Case</h5>
                </div>
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-primary-rgba btn-block btn-lg font-16"><i class="feather icon-plus mr-2"></i>Add Cases</button>
                </div>
            </div>
        </div>
        <!-- End col -->
