                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>$1,25,000</td>
                                    <td>Vancouver</td>
                                    <td><span class="badge badge-primary-inverse">Paid</span></td>
                                    <td>
                                        <div class="button-list">
                                            <a href="/admin-invoice" class="btn btn-primary-rgba"><i class="feather icon-file"></i></a>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge badge-success-inverse">Partially refunded</span></td>
                                    <td>
                                        <div class="button-list">
                                            <a href="/admin-invoice" class="btn btn-primary-rgba"><i class="feather icon-file"></i></a>
                                            <a href="#" class="btn btn-success-rgba"><i class="feather icon-edit-2"></i></a>
                                ...
                                <tr>
                                    ...
                                    <td>$1,45,000</td>
                                    <td>Burnaby</td>
                                    <td><span class="badge badge-warning-inverse">Fully Refunded</span></td>
                                    <td>
                                        <div class="button-list">
                                            <a href="/admin-invoice" class="btn btn-primary-rgba"><i class="feather icon-file"></i></a>
                                            <a href="#" class="btn btn-success-rgba"><i class="feather icon-edit-2"></i></a>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge badge-danger-inverse">Due</span></td>
                                    <td>
                                        <div class="button-list">
                                            <a href="/admin-invoice" class="btn btn-primary-rgba"><i class="feather icon-file"></i></a>
                                            <a href="#" class="btn btn-success-rgba"><i class="feather icon-edit-2"></i></a>
