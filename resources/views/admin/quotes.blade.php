        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h5 class="card-title mb-0">All Quotes</h5>
                        </div>
                        <div class="col-6">
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="button-list">
                                            <a href="/admin-quote" class="btn btn-primary-rgba"><i class="feather icon-file"></i></a>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge badge-secondary-inverse">Assigned</span></td>
                                    <td>
                                        <div class="button-list">
                                            <a href="/admin-quote" class="btn btn-primary-rgba"><i class="feather icon-file"></i></a>
                                            <a href="#" class="btn btn-success-rgba"><i class="feather icon-edit-2"></i></a>
                                ...
                                <tr>
                                    ...
                                    <td>$1,45,000</td>
                                    <td>Burnaby</td>
                                    <td><span class="badge badge-warning-inverse">Cancelled</span></td>
                                    <td>
                                        <div class="button-list">
                                            <a href="/admin-quote" class="btn btn-primary-rgba"><i class="feather icon-file"></i></a>
                                            <a href="#" class="btn btn-success-rgba"><i class="feather icon-edit-2"></i></a>
