...
$(document).ready(function() {
    ...
    $(function() {
        for (var a = window.location, abc = $(".vertical-menu a").filter(function() {
            ...
            if ($(".vertical-menu-detail #v-pills-admin").hasClass("show active")) {
                $(".vertical-menu-icon .nav-link").removeClass("active");
                $(".vertical-menu-icon #v-pills-admin-tab").addClass("active");
            }
            if ($(".vertical-menu-detail #v-pills-sales-manager").hasClass("show active")) {
                $(".vertical-menu-icon .nav-link").removeClass("active");
                $(".vertical-menu-icon #v-pills-sales-manager-tab").addClass("active");
            }
            if ($(".vertical-menu-detail #v-pills-mover").hasClass("show active")) {
                $(".vertical-menu-icon .nav-link").removeClass("active");
                $(".vertical-menu-icon #v-pills-mover-tab").addClass("active");
            }
            if ($(".vertical-menu-detail #v-pills-sales-agent").hasClass("show active")) {
                $(".vertical-menu-icon .nav-link").removeClass("active");
                $(".vertical-menu-icon #v-pills-sales-agent-tab").addClass("active");
            }
            if ($(".vertical-menu-detail #v-pills-owner-operator").hasClass("show active")) {
                $(".vertical-menu-icon .nav-link").removeClass("active");
                $(".vertical-menu-icon #v-pills-owner-operator-tab").addClass("active");
            }
            if ($(".vertical-menu-detail #v-pills-affiliate").hasClass("show active")) {
                $(".vertical-menu-icon .nav-link").removeClass("active");
                $(".vertical-menu-icon #v-pills-affiliate-tab").addClass("active");
            }
            if ($(".vertical-menu-detail #v-pills-client").hasClass("show active")) {
                $(".vertical-menu-icon .nav-link").removeClass("active");
                $(".vertical-menu-icon #v-pills-client-tab").addClass("active");
            }
