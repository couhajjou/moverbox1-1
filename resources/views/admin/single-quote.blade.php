    ...
    <div class="row">
        ...
        <div class="col-lg-7 col-xl-8">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-xl-6 ">
                            <div class="order-primary-detail mb-4">
                            <h6>Pick Up Address <a href="#" class="badge badge-primary-inverse">Edit</a></h6>
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6 ">
                            <div class="order-primary-detail mb-4">
                            <h6>Drop Off Address <a href="#" class="badge badge-primary-inverse">Edit</a></h6>
                            <p>525 Marin Drive, New Street,<br/> Royal Park, <br/> Florida-12345</p>
                            <p class="mb-0">+1 987 654 3210</p>
                            </div>
                        </div>
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><img src="assets/images/sofa-icon.png" class="img-fluid" width="35" alt="product"></td>
                                ...
                                <tr>
                                    <th scope="row">2</th>
                                    <td><a href="#" class="text-success mr-2"><i class="feather icon-edit-2"></i></a><a href="#" class="text-danger"><i class="feather icon-trash"></i></a></td>
                                    <td><img src="assets/images/armchair-icon.png" class="img-fluid" width="35" alt="product"></td>
                                    <td>Armchair</td>
                                    <td>2</td>
                                    <td>Small</td>
                                ...
                                <tr>
                                    <th scope="row">3</th>
                                    <td><a href="#" class="text-success mr-2"><i class="feather icon-edit-2"></i></a><a href="#" class="text-danger"><i class="feather icon-trash"></i></a></td>
                                    <td><img src="assets/images/box-icon.jpg" class="img-fluid" width="35" alt="product"></td>
                                    <td>Frog Box</td>
                                    <td>15</td>
                                    <td>Medium</td>
            ...
            <div class="card m-b-30">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-7">
                            <h5 class="card-title mb-0">Quote PDF Details</h5>
                        </div>
                        <div class="col-5 text-right">
                            <button type="button" class="btn btn-success py-1"><i class="feather icon-download mr-2"></i>Quote</button>
                        </div>
                    </div>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-5 col-xl-4">
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <p><button type="button" class="btn btn-primary-rgba my-1"><i class="feather icon-file mr-2"></i>Quote</button></p>
